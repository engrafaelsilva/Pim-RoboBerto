...
{
    public partial class PainelTecnicoFrm : Form
    {

        private string _token;
        public PainelTecnicoFrm()
        {
            InitializeComponent();
        }
        public PainelTecnicoFrm(string token)
        {
            _token = token;
            InitializeComponent();
        }
        ...
        private void PainelTecnicoFrm_Load(object sender, EventArgs e)
        {
        }
        ...
        {
            CarregarForm(new ChamadosAbertosFrm(_token));
        }

        private void chamadosAssumidosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CarregarForm(new ChamadosAssumidosFrm(_token));
        }
        ...
        private void chamadosExpiradosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CarregarForm(new ChamadosExpiradosFrm(_token));
        }
    }
}
