...
{
    public partial class PainelAdministradorFrm : Form
    {

        private string _token;
        public PainelAdministradorFrm()
        {
            InitializeComponent();
        }
        public PainelAdministradorFrm(string token)
        {
            _token = token;
            InitializeComponent();
        }
        ...
        private void PrincipalFormTeste_Load(object sender, EventArgs e)
        {
        }
        ...
        private void gerenciamentoDeCategoriasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CarregarForm(new CategoriaFrm(_token));
        }



        private void gerenciamentoDeDepartamentosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CarregarForm(new DepartamentoFrm(_token));
        }
